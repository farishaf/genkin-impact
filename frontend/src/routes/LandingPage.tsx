...
const DEMO = {
  ...
  dayOut: "685000",
  rows: [
    { key: "K", name: "Kopi", time: "09:41", meta: "BCA · Food & drink", amount: "45000" },
    { key: "T", name: "Transport", time: "08:12", meta: "GoPay · Daily", amount: "28000" },
    { key: "L", name: "Listrik", time: "07:30", meta: "BCA · Utilities", amount: "612000" },
  ],
};
...
const HEAT_KIND: Record<string, string | undefined> = { o: "out-lo", O: "out-hi", i: "in" };
      ...
      <main id="top">
        <section className="lp-shell lp-hero">
          ...
          <p className="lp-hero__lede lp-rise">
            Every transaction, account and plan in one ledger — with the heatmaps and trends that show where the money
            actually went.
          </p>

          <div className="lp-glass lp-panel lp-rise">
            ...
            <div className="lp-stats">
              <div className="lp-stat">
                <div className="lp-stat__head">
                  <span className="lp-stat__dot" style={{ background: "var(--color-income)" }} aria-hidden="true" />
              ...
              <div className="lp-stat">
                <div className="lp-stat__head">
                  <span className="lp-stat__dot" style={{ background: "var(--color-expense)" }} aria-hidden="true" />
              ...
              <div className="lp-stat">
                <div className="lp-stat__head">
                  <span className="lp-stat__dot" style={{ background: "var(--color-balance)" }} aria-hidden="true" />
            ...
            <div>
              {DEMO.rows.map((row, i) => (
                <div className={`lp-txn${i === DEMO.rows.length - 1 ? " lp-txn--fade" : ""}`} key={row.name}>
          ...
          <div className="lp-hero__cta">
            ...
            <a className="lp-btn lp-btn--outline" href="#features">
              See how it works
            </a>
          </div>
        </section>
        ...
        <div className="lp-shell">
          <p className="lp-capability" id="privacy">
            <span>
              <b>7 currencies</b> — IDR, USD, JPY, CNY, EUR, GBP, HKD
            </span>
            <span>
              <b>Manual entry</b> — no bank credentials asked for
            </span>
            <span>
              <b>Self-hosted</b> — your ledger stays on your server
            </span>
          </p>
        </div>
          ...
          <div className="lp-tiles">
            <article className="lp-tile">
              ...
              <p className="lp-tile__body">
                A month of spending as one grid. Heavy days stand out before you read a single number.
              </p>
            ...
            <article className="lp-tile" id="analytics">
              ...
              <p className="lp-tile__body">
                Income against expenditure over time, by category or account, so a bad month has an explanation.
              </p>
              <div className="lp-tile__art">
                <div className="lp-bars" aria-hidden="true">
                  {BARS.map((h, i) => (
                    <i key={i} style={{ height: `${h}%` }} data-b={BAR_IN.has(i) ? "in" : "out"} />
                  ))}
                </div>
              </div>
            </article>
            ...
            <article className="lp-tile">
              ...
              <p className="lp-tile__body">
                Tags, members, accounts, attachments and refunds — the detail is there when you need to audit it.
              </p>
              <div className="lp-tile__art">
                <div className="lp-mini-rows" aria-hidden="true">
                  {DEMO.rows.map((row) => (
                    <div className="lp-mini-row" key={row.name}>
                      ...
                      <span className="lp-mini-row__amt">−{rp(row.amount)}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="lp-shell lp-close">
          ...
          <p className="lp-close__note">Free while in development. No card, no bank linking.</p>
        </section>
      </main>
